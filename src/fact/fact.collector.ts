...
import { initFacts } from './fact.initiator';
import { IFactCollector } from './types/fact-collector.interface';
import { IFactSource } from './types/fact-source.interface';
import { IFacts } from './types/facts.interface';

export class FactCollector implements IFactCollector {
  protected facts: IFacts = initFacts();
